...
import { LoginContext, LoginContextInterface } from "../context/loginContext";
...
const Header = (props : any) => {
    ...
    const cartCount = loginContext?.cartCount || 0;
    const notificationCount = loginContext?.notificationCount || 0;
