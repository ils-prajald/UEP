...
const ContactUEP = ({ props, navigation, route }: any) => {
        ...
        <View style={styles.contentView}>
          <ScrollView style={{ width: "100%" }}>
            ...
            <View style={styles.informationTextView}>
              <ContentHeader text={headerText.address_text} />
              <InfoHeader text={address} />
              <InfoHeader text={address1} />
            </View>

            <View style={styles.informationTextView}>
              <ContentHeader text={headerText.telephone_text} />
              <TouchableOpacity
                onPress={() => {
            ...
            <View style={styles.informationTextView}>
              <ContentHeader text={headerText.email_text} />
              <TouchableOpacity
                onPress={() => {
            ...
            <View style={styles.bottomButtonView}>
              <UEPButton title={headerText.chat_with_us_text} onPressButton={() => { navigation.navigate("Chat") }} />
            </View>
          </ScrollView>
        </View>
      </SafeAreaView>
