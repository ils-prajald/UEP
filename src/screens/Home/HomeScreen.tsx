                    ...
                    {/* {WiFi === false ?
                      <View style={styles.actionView}>
                        {store.token || savedUser !== "" ? (
                          ...
                          >
                            <Text style={styles.actionText}>{headerText.view_my_profile_text}</Text>
                          </TouchableOpacity>
                        ) : (
                      ...
                      {/* <View style={styles.wifiActionView}>
                        <Text style={styles.actionText}>
                          {headerText.view_my_profile_text}
                        </Text>
                      </View> */}
                     {/* } */}
                  </View>
                ...
                >
                  <View style={styles.actionContainerView}>
                    {/* <View style={styles.actionView}>
                      ...
                      >
                        <Text style={styles.actionText}>
                          {headerText.search_for_event_media_text}
                        </Text>
                      </TouchableOpacity>
                    </View> */}
                  </View>
                    ...
                    {/* {WiFi === false ?
                      <View style={styles.actionView}>
                        {store.token || savedUser !== "" ? (
                          ...
                          >
                            <Text style={styles.actionText}>
                              {headerText.view_purchased_media_text}
                            </Text>
                          </TouchableOpacity>
                        ) : (
                          <TouchableOpacity style={styles.actionButtonView}>
                  ...
                  <View style={styles.actionContainerView}>
                    {/* {WiFi === false ? */}
                      <View style={styles.actionView}>
                        ...
                        >
                          <Text style={styles.actionText}>{headerText.contact_uep_text}</Text>
                        </TouchableOpacity>
                      </View> 
                      {/* :  */}
                      {/* <View style={styles.wifiActionView}>
                        <Text style={styles.actionText}>
                          {headerText.contact_uep_text}
                        </Text>
                      </View> */}
                      {/* } */}
                  </View>
            ...
            <TouchableOpacity onPress={async () => await Linking.openURL('https://www.uephd.com/contactless-order-form-landing')}>
              {/* <Text> */}
                <Text style={styles.placeAnOrderText}>
                  {headerText.place_pre_order_for_upcoming_event_text}
                </Text>
              {/* </Text> */}
            </TouchableOpacity>
          </View>
